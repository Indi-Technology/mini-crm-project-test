...
@section('content-agent')
    <div class="container-xxl flex-grow-1 container-p-y">
        <nav aria-label="breadcrumb" class="d-flex justify-content-end px-2">
            <ol class="breadcrumb breadcrumb-style1">
                <li class="breadcrumb-item">
                    <a href="{{ route('agent.tickets.index') }}" class="text-muted fw-light">Tickets</a>
                </li>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('agent.tickets.update', $ticket->id_tickets) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
