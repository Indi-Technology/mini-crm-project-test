        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <div class="mt-1 flex space-x-4">
                @foreach ($labels as $label)
                    <div>
                        <input id="label-{{ $label->id }}" type="checkbox" value="{{ $label->id }}"
                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="label-{{ $label->id }}" class="ms-2 text-sm font-medium text-gray-900 dark:text-gra">
                            {{ $label->name }}
                        </label>
                    </div>
                @endforeach
            ...
            <label class="block mt-4 mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Attachment
                (Mengupload byk file) (storage/app/public) (maks 2 mb)</label>
            <input
