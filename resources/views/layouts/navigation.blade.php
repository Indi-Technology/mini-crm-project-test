        ...
        <div class="flex items-center justify-between ">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="#" class="flex ms-2 md:me-24">
                    ...
                    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Ticket
                        System</span>
                </a>
            </div>
            <div class="flex items-center">
                <div class="flex items-center ms-3">
                    <div>
                        <button type="button"
                            class="flex items-center p-1 bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                            aria-expanded="false" data-dropdown-toggle="dropdown-user">
                            <span class="sr-only">Open user menu</span>
                            <img class="w-8 h-8 rounded-full" src="{{ asset('img/avatar.jpeg') }}" alt="user photo">
                            <div class="text-white ms-2">{{ Auth::user()->name }}</div>
                        </button>
                    </div>
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                        ...
                        <ul class="py-1" role="none">
                            <li>
                                <a href="{{ route('profile.edit') }}" style="cursor: pointer;"
        ...
        <ul class="space-y-2 font-medium">
            @can('admin')
                <li>
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                        <svg class="w-5 h-5 me-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            ...
            <li>
                <x-nav-link href="{{ route('ticket.index') }}" :active="request()->routeIs('ticket.index') ||
                    ...
                    request()->routeIs('ticket.detail')">
                    <svg class="flex-shrink-0 w-5 h-5 me-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            ...
            @can('admin')
                <li>
                    <x-nav-link href="{{ route('ticket.log') }}" :active="request()->routeIs('ticket.log')">
                        <svg class="flex-shrink-0 w-5 h-5 me-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            ...
            @can('admin')
                <li>
                    <x-nav-link href="{{ route('akun.index') }}" :active="request()->routeIs('akun.index') ||
                        request()->routeIs('akun.create') ||
                        request()->routeIs('akun.edit')">
                        <svg class="flex-shrink-0 w-5 h-5 me-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                ...
                <li>
                    <x-nav-link href="{{ route('category.index') }}" :active="request()->routeIs('category.index') ||
                        request()->routeIs('category.create') ||
                        request()->routeIs('category.edit')">
                        <svg class="flex-shrink-0 w-5 h-5 me-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                ...
                <li>
                    <x-nav-link href="{{ route('label.index') }}" :active="request()->routeIs('label.index') ||
                        request()->routeIs('label.create') ||
                        request()->routeIs('label.edit')">
                        <svg class="flex-shrink-0 w-5 h-5 me-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
