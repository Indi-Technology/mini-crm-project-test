    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            @if (auth()->user()->role === 'admin')
                <li>
                    <x-sidebar-link :href="route('logs.index')" :active="request()->routeIs('logs.index')">
                        <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Ticket Logs</span>
                    </x-sidebar-link>
                </li>
                <li>
                ...
                <li>
                    <x-sidebar-link :href="route('labels.index')" :active="request()->routeIs('labels.index')">
                        <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            fill="currentColor" viewBox="0 0 24 24">
                            <path
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Labels</span>
                    </x-sidebar-link>
                </li>
            @endif
